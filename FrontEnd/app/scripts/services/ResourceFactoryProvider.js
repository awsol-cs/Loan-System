        ...
        ResourceFactoryProvider: function () {
            ...
            this.$get = ['$resource', '$rootScope', function (resource, $rootScope) {
                ...
                return {
                    ...
                    addCreditBureau: defineResource(apiVer + "/CreditBureauConfiguration/cs/createCreditBureau/",{},{
                        post:{method:'POST',params:{}}
                    }),
                    configOrgCreditBureau: defineResource(apiVer + "/CreditBureauConfiguration/organisationCreditBureau/:ocbId",{},{
                        post:{method:'POST',params:{}}
                    }),
                   ...
                   provisioningcriteria: defineResource(apiVer + "/provisioningcriteria/:criteriaId",{criteriaId:'@criteriaId'},{
                    ...
                    creditScoreResource: defineResource(apiVer+"/creditscore/:clientId/", {clientId: '@clientId'}, {
                        getCreditScore: {method: 'GET', params: {}},
                        put: {method: 'PUT', params: {}}
                    }),
                    scoreManagerResource: defineResource(apiVer+"/scoremanager", {}, {
                        getScoreRuleList: {method: 'GET', params: {}, isArray: true},
                        addScoreRule: {method: 'POST', params:{}}
                    }),
                    ...
                    transferLoanResource: defineResource(apiVer+"/transferloan", {}, {
                    }),
