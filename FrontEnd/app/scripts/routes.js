(function (mifosX) {
    var defineRoutes = function ($routeProvider, $locationProvider) {
        $routeProvider
            ...
            .when('/externalservicesCB/CreditBureau/configurecb', {
                 templateUrl: 'views/administration/ConfigureCreditBureau.html'
            })
            ...
            .when('/addrule/', {
                templateUrl: 'views/scoremanager/AddRule.html'
            })
            .when('/viewrule/:id', {
                templateUrl: 'views/scoremanager/ViewRule.html'
            })
            .when('/editrule/:id', {
            ...
            .when('/editformula/:id', {
                templateUrl: 'views/scoremanager/EditFormula.html'
            })
            .when('/viewformula/:id', {
