...
public class CS_CreateCreditScoreCommandHandler implements CS_NewCommandSourceHandler {

    private final CS_CreditScoreWritePlatformService writePlatformService;
    
    @Autowired
    public CS_CreateCreditScoreCommandHandler(CS_CreditScoreWritePlatformService writePlatformService) {
