...
@Service
@CommandType(entity = "CS_LOAN", action = "CREATE")
public class CS_LoanApplicationSubmittalCommandHandler implements CS_NewCommandSourceHandler {

    private final CS_LoanApplicationWritePlatformService writePlatformService;

    @Autowired
    public CS_LoanApplicationSubmittalCommandHandler(final CS_LoanApplicationWritePlatformService writePlatformService) {
