...
public interface CS_CoMakerWritePlatformService {

    CS_CoMaker CreateCoMaker(JsonCommand command, Loan loan, CS_KycInfo kycInfo);

    CommandProcessingResult UpdateCoMaker(CS_JsonCommand command);
