...
final public class CS_ClientData implements Comparable<CS_ClientData> {
    ...
    private CS_KycInfoData kycInfo;

    public static CS_ClientData importClientEntityInstance(Long legalFormId,Integer rowIndex,String fullname,Long officeId, Long clientTypeId,
        ...
        return  new CS_ClientData(legalFormId,rowIndex,fullname, null, null, null, submittedOnDate,activationDate,active, externalId,
    ...
    public static CS_ClientData importClientPersonInstance(Long legalFormId,Integer rowIndex,String firstName,String lastName,String middleName,
        ...
        return new CS_ClientData(legalFormId,rowIndex, null, firstName,lastName,middleName,submittedOn,activationDate,active,externalId,
                officeId,staffId,mobileNo,dob,clientTypeId,genderId,clientClassificationId,isStaff,address, null, locale,dateFormat);
    }

    public static CS_ClientData emptyInstance(Long clientId) {
    		return lookup(clientId, null, null, null);
    }

    private CS_ClientData(Long legalFormId,Integer rowIndex, String fullname, String firstname,String lastname,String middlename,
            LocalDate submittedOn,LocalDate activationDate,Boolean active,String externalId,Long officeId,
            Long staffId,String mobileNo, LocalDate dob,Long clientTypeId,Long genderId,
    ...
    public static CS_ClientData templateWithSavingAccountOptions(final CS_ClientData clientData,
    ...
    public static CS_ClientData setParentGroups(final CS_ClientData clientData, final Collection<GroupGeneralData> parentGroups) {
        return new CS_ClientData(clientData.accountNo, clientData.status, clientData.subStatus, clientData.officeId, clientData.officeName,
                clientData.transferToOfficeId, clientData.transferToOfficeName, clientData.id, clientData.firstname, clientData.middlename,
                clientData.lastname, clientData.fullname, clientData.displayName, clientData.externalId, clientData.mobileNo, clientData.emailAddress,
                clientData.dateOfBirth, clientData.gender, clientData.activationDate, clientData.imageId, clientData.staffId,
    ...
    public static CS_ClientData clientIdentifier(final Long id, final String accountNo, final String firstname, final String middlename,
    ...
    public static CS_ClientData lookup(final Long id, final String displayName, final Long officeId, final String officeName) {
        final String accountNo = null;
        final EnumOptionData status = null;
        final CodeValueData subStatus = null;
        final Long transferToOfficeId = null;
    ...
    public static CS_ClientData instance(final Long id, final String displayName){
    	 final Long officeId = null;
    	 final String officeName = null;
    	 return lookup(id, displayName, officeId, officeName);
    }

    public static CS_ClientData instance(final String accountNo, final EnumOptionData status, final CodeValueData subStatus,
    ...
    @Override
    public int compareTo(final CS_ClientData obj) {
    ...
    public boolean equals(final Object obj) {
        ...
        final CS_ClientData rhs = (CS_ClientData) obj;
    ...
    public void setKycInfo(CS_KycInfoData kycInfo){
        this.kycInfo = kycInfo;
    }
}