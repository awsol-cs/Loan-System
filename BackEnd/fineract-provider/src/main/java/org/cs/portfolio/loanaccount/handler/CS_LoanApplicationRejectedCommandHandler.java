...
@Service
@CommandType(entity = "LOAN_APP", action = "REJECT")
public class CS_LoanApplicationRejectedCommandHandler implements CS_NewCommandSourceHandler {

    private final CS_LoanApplicationWritePlatformService writePlatformService;

    @Autowired
    public CS_LoanApplicationRejectedCommandHandler(final CS_LoanApplicationWritePlatformService writePlatformService) {
