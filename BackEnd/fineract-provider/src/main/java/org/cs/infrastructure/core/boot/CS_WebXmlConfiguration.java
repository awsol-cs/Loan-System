 ...
 * under the License.
 */
package org.cs.infrastructure.core.boot;

import javax.servlet.Filter;
import javax.servlet.Servlet;

import org.cs.infrastructure.core.filters.CS_ResponseFilter;
...
@Configuration
@Profile("basicauth")
public class CS_WebXmlConfiguration {
    ...
    public ServletRegistrationBean jersey() {
        ...
        jerseyServletRegistration.addInitParameter("com.sun.jersey.spi.container.ContainerResponseFilters",
                CS_ResponseFilter.class.getName());
