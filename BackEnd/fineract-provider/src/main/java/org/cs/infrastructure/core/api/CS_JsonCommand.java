 ...
 * under the License.
 */
package org.cs.infrastructure.core.api;
 ...
 */
public final class CS_JsonCommand {
    ...
    private final Integer scoreManagerId;
    private final Long creditScoreId;
    private final Long formulaId;

    public static CS_JsonCommand from(final String jsonCommand, final JsonElement parsedCommand, final FromJsonHelper fromApiJsonHelper, final String entityName,
            ...
            final Integer scoreManagerId, final Long creditScoreId, final Long formulaId) {
        return new CS_JsonCommand(null, jsonCommand, parsedCommand, fromApiJsonHelper, entityName, resourceId, subresourceId, groupId, clientId, loanId, savingsId,
                transactionId, url, productId,creditBureauId,organisationCreditBureauId, scoreManagerId, creditScoreId, formulaId);

    }

    public static CS_JsonCommand fromExistingCommand(final Long commandId, final String jsonCommand, final JsonElement parsedCommand,
            ...
            final Long creditBureauId,final Long organisationCreditBureauId, final Integer scoreManagerId, final Long formulaId) {
        return new CS_JsonCommand(commandId, jsonCommand, parsedCommand, fromApiJsonHelper, entityName, resourceId, subresourceId, null, null, null, null, null, url,
                productId,creditBureauId,organisationCreditBureauId, scoreManagerId, null, formulaId);
    }
    ...
    public static CS_JsonCommand fromExistingCommand(final Long commandId, final String jsonCommand, final JsonElement parsedCommand, 
            ...
            final Long organisationCreditBureauId, final Integer scoreManagerId, final Long formulaId) {
        return new CS_JsonCommand(commandId, jsonCommand, parsedCommand, fromApiJsonHelper, entityName, resourceId, subresourceId, groupId, clientId, loanId, savingsId,
                transactionId, url, productId,creditBureauId,organisationCreditBureauId, scoreManagerId, null, formulaId);

    }

    public static CS_JsonCommand fromExistingCommand(CS_JsonCommand command, final JsonElement parsedCommand) {
        final String jsonCommand = command.fromApiJsonHelper.toJson(parsedCommand);
        return new CS_JsonCommand(command.commandId, jsonCommand, parsedCommand, command.fromApiJsonHelper, command.entityName, command.resourceId, command.subresourceId,
                ...
                command.organisationCreditBureauId, command.scoreManagerId, null, command.formulaId);
    }

    public CS_JsonCommand(final Long commandId, final String jsonCommand, final JsonElement parsedCommand, final FromJsonHelper fromApiJsonHelper, final String entityName,
            final Long resourceId, final Long subresourceId, final Long groupId, final Long clientId, final Long loanId, final Long savingsId,
            final String transactionId, final String url, final Long productId,final Long creditBureauId, final Long organisationCreditBureauId,
            final Integer scoreManagerId, final Long creditScoreId, final Long formulaId) {
    ...
    public static CS_JsonCommand fromJsonElement(final Long resourceId, final JsonElement parsedCommand) {
        return new CS_JsonCommand(resourceId, parsedCommand);
    }
    
    public CS_JsonCommand(final Long resourceId, final JsonElement parsedCommand) {
        this.parsedCommand = parsedCommand;
        this.resourceId = resourceId;
        this.commandId = null;
    ...
    public Integer getScoreManagerId() {
        return this.scoreManagerId;
    }
