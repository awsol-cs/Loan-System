 ...
 * under the License.
 */
package org.cs.infrastructure.creditbureau.domain;
...
public class CS_CreditBureau extends AbstractPersistableCustom<Long> {
	...
	public CS_CreditBureau(String name, String product, String country, String implementationKey,
	...
	public CS_CreditBureau() {

	}

	public static CS_CreditBureau fromJson(final CS_JsonCommand command) {
		...
		return new CS_CreditBureau(tname, tproduct, tcountry, timplementationKey, null);
