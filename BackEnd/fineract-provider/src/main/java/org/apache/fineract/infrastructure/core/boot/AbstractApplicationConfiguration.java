...
import org.cs.infrastructure.core.boot.CS_WebXmlConfiguration;
 ...
 */
@Configuration
@Import({ CS_WebXmlConfiguration.class, WebXmlOauthConfiguration.class, WebFrontEndConfiguration.class,
